...
// import GridManagerReact from "../GridTable/index";
import GridManagerReact from "../GirdTable";
  ...
  return [
    {
      ...
      template: (pic, row) => {
        // return (
        //   <img
        //     style={{ width: "90px", height: "58.5px", margin: "0 auto" }}
        //     src={"https://www.lovejavascript.com" + pic}
        //     title={row.name}
        //   />
        // );
        return pic;
    ...
    //     return (
    //       <a href={"https://github.com/baukh789"} target={"_black"}>
    //         {username}
    //       </a>
    //     );
    //   },
    ...
    },
    {
      ...
      template: (action, row, index) => {
        return (
          <>
            <EditComponents row={row} index={index} gmkey={"test"} />
            <span className="plugin-action" onClick={testFN}>
              state
            </span>
          </>
        );
...
const GridTable = () => {
  const columnData = getColumnData(1, () => {});
    ...
    <div style={{ height: "900px" }}>
      <GridManagerReact
        ...
        emptyTemplate={(settings) => {
          return getEmptyTemplate(settings.query, 1, () => {});
        }}
        callback={() => {}}
      />
    </div>
